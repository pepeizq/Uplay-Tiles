            ...
            If listaJuegos.Count > 0 Then
                For Each juego In listaJuegos
                    If Not juego Is Nothing Then
                        Try
                            If Await helper.FileExistsAsync("Juegos\juego_" + juego.IDUplay) = False Then
                                Await helper.SaveFileAsync(Of Tile)("Juegos\juego_" + juego.IDUplay, juego)
                            End If
                        Catch ex As Exception

                        End Try

                        resultadosBusqueda.Add(New Interfaz.BusquedaFichero(juego.Titulo, "Juegos\juego_" + juego.IDUplay))
                    End If
                Next
            End If
        End If
