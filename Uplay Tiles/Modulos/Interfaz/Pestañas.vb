Namespace Interfaz
    Module Pestañas
        ...
        Public Sub Visibilidad_Pestañas(gridMostrar As Grid, tag As String)
            ...
            tbTitulo.Text = recursos.GetString("Ubi_Title") + " (" + Package.Current.Id.Version.Major.ToString + "." + Package.Current.Id.Version.Minor.ToString + "." + Package.Current.Id.Version.Build.ToString + "." + Package.Current.Id.Version.Revision.ToString + ")"
