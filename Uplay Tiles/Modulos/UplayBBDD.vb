Module UplayBBDD
    ...
    Public Function Listado()
        ...
        Dim lista As New List(Of UplayBBDDEntrada) From {
            ...
            New UplayBBDDEntrada("Assassin's Creed III", "54", "208480", New List(Of UplayBBDDPaisID) From {New UplayBBDDPaisID("RU", "103")}),
            ...
            New UplayBBDDEntrada("Assassin's Creed Rogue", "895", "311560", New List(Of UplayBBDDPaisID) From {New UplayBBDDPaisID("RU", "186")}),
